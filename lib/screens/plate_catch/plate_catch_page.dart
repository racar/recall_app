...
class PlateCatchPage extends StatefulWidget {
  @override
  PlateCatchPageState createState() => PlateCatchPageState();
}

class PlateCatchPageState extends State<PlateCatchPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text('checkyourvehicles.com'),
      ),
      body: Column(
        children: [
          Expanded(
