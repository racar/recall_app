...
const TEXT_WELCOME_LABEL = "Check your license plate of VIN \n"+
                           "using this app to learn whether your \n"+
                           "vehicle has a Takata airbag recall, which "+
                           "can cause injury and even death. If your vehicle has an airbag recall contact your dealer immediately for a FREE replacement of your airbag.";
...
const BUTTON_GOAHEAD = "CHECK YOUR VEHICLE";
